...
public class Predicate implements Serializable {
  ...
  public boolean filter(Tuple t) {
    // some code goes here
    if (t.getTupleDesc().getItemSize() < this.field) {
      System.out.printf("Tuple length is invalid, tuple length %d, field index %d",
          t.getTupleDesc().getItemSize(), this.field);
      return false;
    }
    // 比反了，他奶奶的
    // return this.operand.compare(this.op, t.getField(this.field));
