...
public class JoinPredicate implements Serializable {
  ...
  public boolean filter(Tuple t1, Tuple t2) {
    // some code goes here
    if (t1.getTupleDesc().getItemSize() < field1 || t2.getTupleDesc().getItemSize() < field2) {
      System.out.printf("invalid field length, t1 %d, field1 %d, t2 %d, field2 %d",
          t1.getTupleDesc().getItemSize(), field1, t2.getTupleDesc().getItemSize(), field2);
      return false;
    }
